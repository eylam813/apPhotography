...
function apphotography_scripts() {
	wp_enqueue_style( 'apphotography-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'apphotography-style', 'rtl', 'replace' );

	wp_enqueue_script( 'apphotography-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'apphotography-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
